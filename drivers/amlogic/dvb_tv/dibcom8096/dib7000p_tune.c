...
static void dib7000p_set_channel(struct dib7000p_state *state, struct dibChannel *ch, uint8_t seq)
{
    ...
    switch (ch->u.dvbt.guard) {
        case GUARD_INTERVAL_1_32_DIB: value |= (0 << 5); break;
        case GUARD_INTERVAL_1_16_DIB: value |= (1 << 5); break;
        case GUARD_INTERVAL_1_4_DIB:  value |= (3 << 5); break;
        default:
        case GUARD_INTERVAL_1_8_DIB:  value |= (2 << 5); break;
    }
    ...
    switch (ch->u.dvbt.guard) {
        case GUARD_INTERVAL_1_16_DIB: value *= 2; break;
        case GUARD_INTERVAL_1_8_DIB:  value *= 4; break;
        case GUARD_INTERVAL_1_4_DIB:  value *= 8; break;
        default:
        case GUARD_INTERVAL_1_32_DIB: value *= 1; break;
    }
...
int dib7000p_autosearch_start(struct dibFrontend *fe, struct dibChannel *ch)
{
    ...
    schan.u.dvbt.guard         = GUARD_INTERVAL_1_32_DIB;
