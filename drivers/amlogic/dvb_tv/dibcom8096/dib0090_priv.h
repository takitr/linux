...
extern int dib0090_dc_offset_calibration(struct dib0090_state *state, enum frontend_tune_state_dib *tune_state);
extern int dib0090_wbd_calibration(struct dib0090_state *state, enum frontend_tune_state_dib *tune_state);
extern int dib0090_get_temperature(struct dib0090_state *state, enum frontend_tune_state_dib *tune_state);
extern int dib0090_captrim_search(struct dib0090_state *state, enum frontend_tune_state_dib *tune_state);
