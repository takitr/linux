...
#define GUARD_INTERVAL_AUTO_DIB -1
#define GUARD_INTERVAL_1_32_DIB  0
#define GUARD_INTERVAL_1_16_DIB  1
#define GUARD_INTERVAL_1_8_DIB   2
#define GUARD_INTERVAL_1_4_DIB   3

#define QAM_AUTO_DIB   90
#define QAM_QPSK    0
#define QAM_16QAM   1
#define QAM_64QAM   2
#define QAM_DQPSK   3
...
/*chip id*/
#define CHIPID_ERROR 0
#define CHIPID_8096 1
#define CHIPID_7090 2
...
#define ISDBT_INDEX_TO_CONSTELLATION(v) ( \
	...
	(v) == 1 ? QAM_QPSK  : \
	(v) == 2 ? QAM_16QAM : \
	(v) == 3 ? QAM_64QAM : QAM_AUTO_DIB \
)

#define GUARD_INTERVAL_TO_STRING(v) ( \
	(v) == GUARD_INTERVAL_1_32_DIB ? "1/32" : \
	(v) == GUARD_INTERVAL_1_16_DIB ? "1/16" : \
	(v) == GUARD_INTERVAL_1_8_DIB  ? "1/8" : \
	(v) == GUARD_INTERVAL_1_4_DIB  ? "1/4" : "UNK" \
)

#define DVBT_GUARD_INTERVAL_TO_INDEX(v) ( \
	(v) == GUARD_INTERVAL_1_32_DIB ? 0 : \
	(v) == GUARD_INTERVAL_1_16_DIB ? 1 : \
	(v) == GUARD_INTERVAL_1_8_DIB  ? 2 : \
	(v) == GUARD_INTERVAL_1_4_DIB  ? 3 : - 1 \
)

#define DVBT_INDEX_TO_GUARD_INTERVAL(v) ( \
	(v) == 0 ? GUARD_INTERVAL_1_32_DIB : \
	(v) == 1 ? GUARD_INTERVAL_1_16_DIB : \
	(v) == 2 ? GUARD_INTERVAL_1_8_DIB  : \
	(v) == 3 ? GUARD_INTERVAL_1_4_DIB  : GUARD_INTERVAL_AUTO_DIB \
)
...
#define INIT_DVB_CHANNEL(ch) do { \
	...
	(ch)->Bw               = 0;  \
	(ch)->nfft             = FFT_AUTO; \
	(ch)->guard            = GUARD_INTERVAL_AUTO_DIB; \
	(ch)->invspec          = -1; \
	(ch)->nqam             = QAM_AUTO_DIB; \
