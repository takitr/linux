...
static int dib0090_get_offset(struct dib0090_state *state, enum frontend_tune_state_dib *tune_state)
{
...
int dib0090_captrim_search(struct dib0090_state *state, enum frontend_tune_state_dib *tune_state)
{
    int ret = 0;
    uint16_t lo4 = 0xe900;
...
int dib0090_dc_offset_calibration(struct dib0090_state *state, enum frontend_tune_state_dib *tune_state)
{
    int ret = 0;
...
/********************End DC Calib ***************************/
int dib0090_wbd_calibration(struct dib0090_state *state, enum frontend_tune_state_dib *tune_state)
{
    uint8_t wbd_gain;
...
int dib0090_get_temperature(struct dib0090_state *state, enum frontend_tune_state_dib *tune_state)
{
    int ret = 30;
    int16_t val;
