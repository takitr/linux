...
static void gt9xx_read_version(char* ver)
{
	int ret = 0;
	u16 version_info;
	...
	if (ver != NULL)
		sprintf(ver,"Goodix TouchScreen Version:%d\n",version_info);
	else
		printk(KERN_INFO"Goodix TouchScreen Version:%d\n", version_info);
}
static void gt9xx_upgrade_touch(void)
{
	int retry, ret;
