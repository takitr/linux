...
EXPORT_SYMBOL_GPL(register_ntd_blktrans);
EXPORT_SYMBOL_GPL(deregister_ntd_blktrans);
EXPORT_SYMBOL_GPL(add_ntd_blktrans_dev);
EXPORT_SYMBOL_GPL(del_ntd_blktrans_dev);
